...
@WebServlet(initParams = { @WebInitParam(name = "UI", value = "de.sebastianrothbucher.vaadin.meetup.VaadinMeetupUI"),
		@WebInitParam(name = "productionMode", value = "false"), @WebInitParam(name = "disable-xsrf-protection", value = "true"), }, urlPatterns = "/*")
public class VaadinMeetupServlet extends TouchKitServlet {
